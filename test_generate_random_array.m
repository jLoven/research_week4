...
myMatrix = generate_random_array(simple4DMatrix, pillar4DMatrix, 10, 0, 0);
...
givenSeededMatrix4D = givenSeededMatrix(:, :, :, 1);
scatter3(xx(:),yy(:),zz(:), ballsize, givenSeededMatrix4D(:), 'filled')